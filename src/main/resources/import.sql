...
-- INSERT INTO Game (name, description, ageRating) VALUES ('Fifa 2', 'asduhnf', '3+');
-- INSERT INTO Game (name, description, ageRating) VALUES ('test', 'hgjfg', '18+');
-- INSERT INTO Game (name, description, ageRating) VALUES ('Testing Apple', 'fdgs', '6+');